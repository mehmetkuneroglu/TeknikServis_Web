        ...
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
                    <h1>En uygun fiyatlarla yüzlerce ürün
	<br>
                        bir tıkla kapınızda.</h1>
                    <p class="banp mx-auto mt-3">24 farkı kategoride yüzlerce ürünle sizlerleyiz.  </p>
        ...
        <section class="slide-wrapper" id="about">
            ...
            <img src="web/images/about1.png" class="img-fluid" alt="">
            <p class="iner mt-5">
        ...
        <div class="wthree_pvtits-services align-w3" id="services">
            <div class="container">
                <div class="wthree_pvt_title text-center">
                    <h3 class="w3_head">Teknik Servis </h3>
                    <p class="main_p mb-5  text-center mx-auto">Mağazamızdan almış olduğunuz ürünlerde herhangi bir teknik problem olursa 2 yıl süre ile herhangi bir ücret ödemeden tamir ve onarım işlemlerini yapmaktayız.</p>
                    <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" style="background-color: #e64f81" href="WebForm1.aspx" role="button">Arızalı Ürün Takibi</a>
                </div>
        ...
        <section class="wedo" id="contact">
            ...
            <p class="main_p mb-5  text-center mx-auto">Mağazamız ya da aldığınız herhangi bir ürünle ilgili soru veya sorununuz olursa bize ulaşabilirsiniz. </p>
            <div class="contact_grid_right mt-5 mx-auto text-center">
                <form action="#contact" method="post" runat="server">
            ...
            <div class="cpy-right text-center">
                ...
                <p>
                    © 2023 Her hakkı saklıdır | Design by
					<a href="http://mehmetkuneroglu.com">Mehmet Kuneroğlu</a>
                </p>
            </div>
        </section>
        <!-- //contact -->
